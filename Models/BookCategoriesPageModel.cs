...
namespace Coltoi_Andrei_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Coltoi_Andrei_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Coltoi_Andrei_Lab8Context context,
